...
const ProductionWaveTimelinePage = lazy(() => import("./pages/ProductionWaveTimelinePage"));
         ...
         <div className="text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
           <p className="text-muted-foreground text-sm mb-4 max-w-xs">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="pt-2 border-t border-muted/50 mt-2 w-full max-w-[200px]">
                <Button 
                  size="sm" 
                  variant="ghost"
                  ...
                  onClick={async () => {
                    ...
                    toast.info("Limpando cache profundo...");
                    await manualVersionCheck();
                    // Se o reload automático falhar/não disparar, damos feedback
                    setTimeout(() => setCheckingVersion(false), 2000);
                  }}
                  className="text-[11px] text-muted-foreground w-full h-auto py-2 hover:text-primary transition-colors"
                >
                  {checkingVersion ? "Limpando..." : "Problemas com a versão? Forçar Limpeza"}
                </Button>
              </div>
            </div>
         </div>
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "pcp/ondas/:waveId/timeline",
        element: <ProductionWaveTimelinePage />,
      },
      {
        path: "pronta-entrega",
