...
export const VALID_TRANSITIONS: Record<string, string[]> = {
  [SALE_ORDER_STATUS.RASCUNHO]: [SALE_ORDER_STATUS.PENDENTE, SALE_ORDER_STATUS.APROVADO, SALE_ORDER_STATUS.CANCELADO],
  [SALE_ORDER_STATUS.PENDENTE]: [SALE_ORDER_STATUS.APROVADO, SALE_ORDER_STATUS.CANCELADO, SALE_ORDER_STATUS.RASCUNHO],
