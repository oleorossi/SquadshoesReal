...
const migration = readFileSync(resolve(
  ROOT,
  'supabase/migrations/20270101014675_permitir_cabedal_com_tiras_e_somar_materiais_cabedal.sql',
), 'utf8');
...
describe('SQL — cabedal e tiras independentes', () => {
  ...
  it('remove o MUTEX dos tres pontos server-side sem expor os writers', () => {
    ...
    expect(migration).toContain('upper_and_straps_coexist_20270101014675');
  ...
  it('deriva Corte Cabedal por sinais reais e preserva o modo somente-tiras', () => {
    ...
    expect(migration).toContain('upper_and_straps_routing_20270101014675');
