...
// CltProvisionsCard removido em 18/05/2026 — pedido user: "férias provisões
// CLT nada disso será calculado. Apenas o salário". Removido o card +
// função. View v_clt_provisions_summary no DB permanece (sem consumo no
// front; pode ser dropada em migration futura se ninguém mais usar).
