  ...
  const { data: sheets = [] } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select('id, name, code, shoe_category, production_sectors, sewing_capacity_per_day, cutting_capacity_per_day, costura_capacity_per_day, costura_cabedal_capacity_per_day, costura_palmilha_capacity_per_day, mesa_daily_capacity, silk_capacity_per_day, gluing_capacity_per_day, assembly_capacity_per_day, soling_capacity_per_day, finishing_capacity_per_day, expedition_capacity_per_day, lead_time_expedicao_dias, requires_cutting, requires_sewing')
        .order('name');
