...
export const SolagemWorkSheet = ({ bands, allSizes, date, grandTotal, pairsPerCard = 12 }: Props) => {
  return (
    ...
    >
      ...
      <div className="border-t-2 border-slate-900 pt-1.5 mt-2 flex items-center justify-between">
        <p className="text-xs text-slate-500">Conferir: total = soma de todos os solados</p>
        <div className="bg-lime-700 text-white px-3 py-1 rounded font-black text-sm">
