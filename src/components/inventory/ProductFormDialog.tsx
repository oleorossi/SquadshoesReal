          ...
          {isEditing && siblings.length > 0 && !copyDismissed && (
           ...
           <div className="grid grid-cols-1 gap-6 mt-4">
            ...
            <div className="col-span-2 p-3 rounded-lg border bg-muted/30 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <Label className="text-xs text-muted-foreground">Unidade de Estoque & Consumo</Label>
                  ...
                  <p className="text-[10px] text-muted-foreground mt-0.5">A mesma usada na ficha técnica</p>
                </div>
                <div>
