        ...
        {onOpenGroupSpecs && (
          <section className="rounded-md border border-dashed px-3 py-2.5 flex items-center justify-between gap-3">
            <div className="min-w-0">
              <p className="text-xs font-medium">Dimensões, embalagem, múltiplo, unidade e custo do grupo</p>
              <p className="text-xs text-muted-foreground">
                Unidade de medida e valor do material também ficam na aba Geral — com confirmação ao aplicar a todos os itens.
              </p>
            </div>
            <Button
              variant="outline"
