      ...
      >
        {tabs.map((tab) => (
          ...
          >
            ...
            {tab.label}
            {tab.badge !== undefined && (
              <span className="ml-0.5 min-w-[18px] h-[18px] rounded-full bg-primary/15 text-primary text-[10px] font-bold flex items-center justify-center px-1 leading-none">
                {tab.badge}
              </span>
            )}
          </TabsTrigger>
