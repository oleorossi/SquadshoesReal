    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-tighter text-foreground">Frota Própria</span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-tighter text-foreground">Transportadora</span>
        </button>
      </div>
        ...
        <div className="bg-primary rounded-3xl p-6 text-primary-foreground shadow-2xl animate-in zoom-in-95 duration-300">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-[10px] text-primary-foreground/40 uppercase font-bold tracking-widest">
              ...
              <div className="pt-4 space-y-3">
                ...
                {!hasSpace ? (
                  <div className="bg-red-500/10 border border-red-500/50 p-3 rounded-xl flex gap-3 items-center mt-4">
                    ...
                    <p className="text-[10px] leading-tight font-bold uppercase text-red-200">
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/50 p-3 rounded-xl flex gap-3 items-center mt-4">
                    ...
                    <p className="text-[10px] leading-tight font-bold uppercase text-emerald-200">
