-- ---------------------------------------------------------------
-- Fix convert_reservation_to_out:
--   Add INSERT INTO stock_movements for every reservation that
--   is converted to a hard debit (soft→hard at Pendente→Corte
--   kanban transition).
--
--   Previously the function updated products.quantity and
--   products.reserved_stock but created no stock_movements
--   record, leaving a gap in the audit trail.
-- ---------------------------------------------------------------
