...
DROP POLICY IF EXISTS "Approved users can view print_jobs" ON public.print_jobs;
CREATE POLICY "Approved users can view print_jobs"
  ON public.print_jobs FOR SELECT TO authenticated
  USING (is_approved_user());

DROP POLICY IF EXISTS "Approved users can insert print_jobs" ON public.print_jobs;
...
DROP POLICY IF EXISTS "Approved users can delete print_jobs" ON public.print_jobs;
...
DROP POLICY IF EXISTS "Approved users can view print_job_items" ON public.print_job_items;
CREATE POLICY "Approved users can view print_job_items"
  ON public.print_job_items FOR SELECT TO authenticated
  USING (is_approved_user());

DROP POLICY IF EXISTS "Approved users can insert print_job_items" ON public.print_job_items;
CREATE POLICY "Approved users can insert print_job_items"
  ON public.print_job_items FOR INSERT TO authenticated
  WITH CHECK (is_approved_user());

DROP POLICY IF EXISTS "Approved users can update print_job_items" ON public.print_job_items;
...
DROP POLICY IF EXISTS "Approved users can delete print_job_items" ON public.print_job_items;
...
DROP POLICY IF EXISTS "Approved users can view financial_entries" ON public.financial_entries;
...
DROP POLICY IF EXISTS "Approved users can view cogs_entries" ON public.cogs_entries;
