-- Fix #7 (auditoria 2026-06-06): commit_capacity_overflow_outsourcing criava service_orders
-- SEM order_id/sale_order_id (OS órfã — só ligada por texto) e sem idempotência (re-submit do
-- override gerava OS duplicada). Agora vincula a OS à OP e pula OP já terceirizada no setor.
