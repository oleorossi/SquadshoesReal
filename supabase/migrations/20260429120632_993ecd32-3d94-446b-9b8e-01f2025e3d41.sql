...
BEGIN
  ...
  RETURN QUERY SELECT
    v_deadline,
    add_business_days(v_deadline, -(v_lead_acab + v_lead_montagem + v_lead_costura + v_lead_corte)),
    add_business_days(v_deadline, -(v_lead_acab + v_lead_montagem + v_lead_costura)),
    add_business_days(v_deadline, -(v_lead_acab + v_lead_montagem)),
    add_business_days(v_deadline, -v_lead_acab),
    add_business_days(v_deadline, -(v_lead_acab + v_lead_montagem + v_lead_costura + v_lead_corte + v_lead_buffer)),
    add_business_days(v_deadline, -(v_lead_acab + v_lead_montagem + v_lead_costura + v_lead_corte + v_lead_buffer + v_lead_supplier));
END;
$$;

-- 6. Comentário de design
