...
-- 2) calculate_order_consumption (single-size) with variant support
...
BEGIN
  ...
  -- Cabedal — respeita p_material_variant_id
...
-- 3) calculate_order_consumption_by_grade (graded) with variant support
