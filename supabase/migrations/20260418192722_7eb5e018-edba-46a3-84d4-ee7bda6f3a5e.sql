...
DROP POLICY IF EXISTS wave_items_select ON public.production_wave_items;
CREATE POLICY wave_items_select ON public.production_wave_items FOR SELECT TO authenticated USING (auth.uid() IS NOT NULL);
DROP POLICY IF EXISTS wave_items_insert ON public.production_wave_items;
...
DROP POLICY IF EXISTS wave_items_update ON public.production_wave_items;
...
DROP POLICY IF EXISTS wave_items_delete ON public.production_wave_items;
...
DROP POLICY IF EXISTS wave_src_select ON public.production_wave_item_sources;
...
DROP POLICY IF EXISTS wave_src_insert ON public.production_wave_item_sources;
...
DROP POLICY IF EXISTS wave_src_update ON public.production_wave_item_sources;
...
DROP POLICY IF EXISTS wave_src_delete ON public.production_wave_item_sources;
...
DROP POLICY IF EXISTS wave_stages_select ON public.production_wave_stages;
CREATE POLICY wave_stages_select ON public.production_wave_stages FOR SELECT TO authenticated USING (auth.uid() IS NOT NULL);
DROP POLICY IF EXISTS wave_stages_insert ON public.production_wave_stages;
...
DROP POLICY IF EXISTS wave_stages_update ON public.production_wave_stages;
...
DROP POLICY IF EXISTS wave_stages_delete ON public.production_wave_stages;
...
DROP POLICY IF EXISTS wave_pkgs_select ON public.production_finishing_packages;
...
DROP POLICY IF EXISTS wave_pkgs_insert ON public.production_finishing_packages;
...
DROP POLICY IF EXISTS wave_pkgs_update ON public.production_finishing_packages;
...
DROP POLICY IF EXISTS wave_pkgs_delete ON public.production_finishing_packages;
