-- =============================================================================
-- Add is_approved_user() guard to create_solo_wave
-- =============================================================================
-- Audit-32 finding [8]: create_solo_wave used only `auth.uid() IS NULL` as its
-- auth guard — missing the is_approved_user() check that all other SECURITY
-- DEFINER RPCs received in passes 28-31. Any unapproved authenticated user could
