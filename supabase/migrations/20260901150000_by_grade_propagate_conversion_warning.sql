-- ============================================================================
-- calculate_order_consumption_by_grade: propaga conversion_warning nos blocos
-- Cabedal / Forração / Palmilha / Forração Palmilha
-- ============================================================================
-- Achado na revisão de bugs de 2026-07-01: só o bloco BOM (sheet_materials)
-- incluía 'conversion_warning', v_conv.conversion_warning no jsonb_build_object.
-- Os blocos Cabedal/Forração/Palmilha/Forração Palmilha — de longe os mais
-- comuns em qualquer PV graduado — chamavam get_material_conversion_info mas
-- descartavam o warning, deixando o usuário sem aviso quando um material sem
-- largura cadastrada inflava o consumo ~100x.
--
-- calculate_order_consumption (escalar) hoje é só um wrapper fino que monta uma
-- grade de tamanho único e delega pra esta função — corrigir aqui cobre os dois
-- caminhos (escalar e graduado) de uma vez.
-- ============================================================================
