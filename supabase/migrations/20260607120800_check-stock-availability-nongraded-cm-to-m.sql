-- Fix BAIXO (auditoria 2026-06-06): ramo NÃO-graduado (ELSE) do loop de tiras em
-- check_stock_availability fazia v_required := v_consumption * p_order_quantity SEM ÷100
-- (cm tratado como metros, 100×). Agora ÷100 igual ao ramo graduado e ao debit_strap_stock.
-- Mantém netting de reservado + emissão de falta (product_id NULL) p/ tira sem cadastro.
