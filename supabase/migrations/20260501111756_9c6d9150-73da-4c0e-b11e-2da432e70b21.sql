...
-- Construction model restructure: 3 production models
-- Model 1: Corte Cabedal (sole + insole ready-made, consumed in units)
-- Model 2: Corte Cabedal + Palmilha Forrada (standard with lining)
-- Model 3: Tiras (no cabedal cut, goes through Mesa sector)

-- 1. mesa_daily_capacity: daily pair capacity at Mesa sector (Model 3 / tiras)
