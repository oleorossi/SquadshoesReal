...
// Extensão .ts explícita: este arquivo é espelhado byte a byte em
// supabase/functions/sync-ar/ (Deno exige extensão em import relativo).
import { parsePaymentConditionInstallments } from './factoringCalc.ts';
